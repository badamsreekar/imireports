...
export default class Navbar extends Component {
      ...
      <nav className={cx("Nav AdminNav sm-py1")}>
        <div className="sm-pl4 flex align-center pr1">
          <div className="NavTitle flex align-center">
            ...
            <span className="NavItem-text ml1 hide sm-show text-bold">{t`IMIchat Advanced Reporting Admin`}</span>
          </div>
  ...
  renderMainNav() {
    return (
      <nav className="Nav relative bg-brand imi-leftmenu">
        <ul className="md-pl4 flex align-center md-pr1">
          <li>
            <Link
              to="/"
              data-metabase-event={"Navbar;Logo"}
              className="LogoNavItem NavItem cursor-pointer text-white flex align-center transition-background justify-center pb1 pt1"
              activeClassName="NavItem--selected"
            >
              <LogoIcon dark={true} />
            </Link>
          </li>
          <li className="hide xs-show">
            <MainNavLink
              to="/dashboards"
              name={t`Dashboards`}
          ...
          <li className="hide xs-show">
            {/* <Link
              ...
              className="NavNewQuestion rounded bg-white text-brand text-bold cursor-pointer px2 no-decoration transition-all"
            >
              {t`New Question`}
            </Link> */}
            <MainNavLink
          ...
          <li className="flex-align-right transition-background hide xs-show profile-btm">
