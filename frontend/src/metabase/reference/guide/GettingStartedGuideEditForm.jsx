...
export default class GettingStartedGuideEditForm extends Component {
  ...
  render() {
    ...
    return (
      <form className="full relative py4 reports-super-container" style={style} onSubmit={onSubmit}>
        {isDashboardModalOpen && (
          <Modal>
            ...
            <div className="wrapper wrapper--trim">
              <div className="mt4 py2">
                <h1 className="my3 text-dark">
                  {t`Help new IMIchat Advanced Reporting users find their way around.`}
                </h1>
