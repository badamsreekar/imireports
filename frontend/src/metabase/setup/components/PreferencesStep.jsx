        ...
        <section className="SetupStep rounded full relative SetupStep--active">
          ...
          <form onSubmit={this.formSubmitted.bind(this)} noValidate>
            <div className="Form-field Form-offset">
              {t`In order to help us improve IMIchat Advanced Reporting, we'd like to collect certain data about usage through Google Analytics.`}{" "}
              <a
                className="link"
                href={
            ...
            <div className="Form-field Form-offset mr4">
              ...
              >
                ...
                />
                <span className="ml1">{t`Allow IMIchat Advanced Reporting to anonymously collect usage events`}</span>
              </div>
            </div>
